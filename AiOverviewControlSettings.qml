...
PluginSettings {
    ...
    readonly property var allProviders: [
        ...
        { id:"commandcode", name:"Command Code", icon:"terminal", mode:"quota", requirement:"API key", envVar:"COMMAND_CODE_API_KEY", note:"Provider API key — same key used for the CLI and the Provider API. Reads /alpha/billing/credits for 5h/weekly/monthly quota; falls back to /provider/v1/models on alpha failure." },
